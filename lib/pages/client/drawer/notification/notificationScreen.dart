...
import 'package:graduation_mobile/pages/client/drawer/notification/allNotification.dart';
      ...
      if (state is NotificationLoading || readyToBuild == false) {
        ...
        return Scaffold(
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Get.to(() => const allNotificationScreen());
            },
            ...
            children: [
              Container(
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                      fontSize: 16, color: Color.fromARGB(255, 246, 26, 26)),
                ),
              ),
              Expanded(
