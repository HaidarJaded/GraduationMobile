    ...
    List<Widget> contentList = <Widget>[
      ...
      if (completedDevice.clientDateWarranty != null)
        Row(
          ...
          children: [
            Text(
                'تاريخ انتهاء كفالة المركز: ${DateFormat('yyyy/MM/dd').format(completedDevice.clientDateWarranty!)}'),
            if (completedDevice.clientDateWarranty != null &&
      ...
      if (completedDevice.customerDateWarranty != null)
        Row(
          ...
          children: [
            Text(
                'تاريخ انتهاء كفالتك : ${DateFormat('yyyy/MM/dd').format(completedDevice.customerDateWarranty!)}'),
            if (completedDevice.customerDateWarranty != null &&
